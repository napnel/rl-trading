...
# from rl_trading.envs.components.action import ActionScheme, MarketOrder
# from rl_trading.envs.components.informe import InformerScheme, PrivateInformer
# from rl_trading.envs.components.observe import ObserverScheme, PublicObserver
# from rl_trading.envs.components.reward import (DifferentialSharpeRatio, LogReturn,
#                                            RewardScheme)
# from rl_trading.envs.components.stop import DrawdownStopper, StopperScheme
...
register(
    id="TradingEnv-v1",
    entry_point="rl_trading.envs:TradingEnv",
